...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7f1c09f5e020, const void *arg_0x7f1c09f5e320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7f1c09ed65e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f1c09c793a0), 
int (*key_eq_fn)(void *arg_0x7f1c09c79b70, void *arg_0x7f1c09c79e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f1c09a66c00, int arg_0x7f1c09a66e80);
static double RandomUniform(void );
...
char PROJECT3TGEN[13] = "Project3TGen";
...
# 5 "lib/modules/NeighborDiscoveryP.nc"
uint16_t sequence = 0;
...
# 7 "lib/modules/FloodingP.nc"
#line 5
typedef struct NodeTable {
  uint16_t lastSeq;
} NodeTable;
# 5 "lib/modules/LinkStateP.nc"
...
typedef TMilli LinkStateP__Delay__precision_tag;
typedef sendInfo /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__t;
typedef sendInfo */*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t;
typedef TMilli /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__precision_tag;
typedef sendInfo /*LinkLayerC.SimpleSendC.PoolC*/PoolC__2__pool_t;
typedef /*LinkLayerC.SimpleSendC.PoolC*/PoolC__2__pool_t /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t;
typedef /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__t;
typedef sendInfo */*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue_t;
typedef /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue_t /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__t;
typedef TMilli TransportP__SendData__precision_tag;
typedef TMilli TransportP__Retransmit__precision_tag;
typedef TMilli TransportP__listenClose__precision_tag;
typedef TMilli TransportP__writeTimer__precision_tag;
typedef tcpPack TransportP__oldPackets__t;
typedef TMilli TransportP__LongClose__precision_tag;
typedef TMilli TransportP__Close__precision_tag;
typedef tcpPack /*TransportC.oldPackets*/QueueC__1__queue_t;
typedef /*TransportC.oldPackets*/QueueC__1__queue_t /*TransportC.oldPackets*/QueueC__1__Queue__t;
...
static void Node__CommandHandler__setTestClient(uint8_t destination, uint8_t sourcePort, uint8_t destinationPort, uint8_t *transfer);
#line 8
static void Node__CommandHandler__setTestServer(uint8_t port);
#line 5
static void Node__CommandHandler__printRouteTable(uint16_t destination);
#line 3
...
static void NeighborDiscoveryP__NeighborDiscovery__newStats(pack *packet);

static void NeighborDiscoveryP__NeighborDiscovery__printNeighbors(void );
#line 5
static uint8_t NeighborDiscoveryP__NeighborDiscovery__getIsNeighbor(int x);
#line 2
static void NeighborDiscoveryP__NeighborDiscovery__start(void );
static void NeighborDiscoveryP__NeighborDiscovery__response(pack *request, uint16_t source);
# 4 "lib/interfaces/LinkLayer.nc"
static void LinkLayerP__LinkLayer__unpackND(pack *msg);
static void LinkLayerP__LinkLayer__unpackF(pack *msg);
#line 3
static void LinkLayerP__LinkLayer__repack(uint16_t src, uint16_t dest, pack payload);
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
LinkLayerP__receivePKG__receive(
#line 71
message_t * msg, 
void * payload, 
...
static void FloodingP__Flooding__sendPack(pack Fpkg, uint16_t Fsrc);
#line 2
static void FloodingP__Flooding__Flood(uint16_t dest, uint8_t protocol, uint8_t *payload);
static void FloodingP__Flooding__control(pack *Fpacket);
# 5 "lib/interfaces/LinkState.nc"
static void LinkStateP__LinkState__SP(void );
static uint16_t LinkStateP__LinkState__getNext(uint16_t dest);
#line 4
static void LinkStateP__LinkState__update(void );



static void LinkStateP__LinkState__printRoutingTable(uint16_t node);
#line 2
static void LinkStateP__LinkState__run(void );
static void LinkStateP__LinkState__fill(uint16_t src, uint8_t *payload);
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void LinkStateP__Delay__fired(void );
# 4 "lib/interfaces/SimpleSend.nc"
static error_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__SimpleSend__send(pack msg, uint16_t dest);
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static void /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
static void /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask__runTask(void );
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__fired(void );
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static error_t /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
static void /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 96
message_t * msg, 
...
static 
#line 94
/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__t * 


/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__get(void );
#line 61
static bool /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__empty(void );
#line 89
static error_t /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__put(
#line 85
/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__t * newVal);
# 62 "/opt/tinyos-main/tos/interfaces/Init.nc"
static error_t /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Init__init(void );
# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
static 
#line 78
/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__t  

/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__head(void );
#line 97
static error_t /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__enqueue(
#line 93
/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__t  newVal);
#line 72
static uint8_t /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__maxSize(void );
#line 88
static 
#line 86
/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__t  

/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__dequeue(void );
#line 50
static bool /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__empty(void );
#line 65
static uint8_t /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__size(void );
# 2 "lib/interfaces/IP.nc"
static void IPP__IP__build(uint16_t src, uint16_t dest, uint8_t protocol, uint8_t *payload);

static void IPP__IP__sortReply(pack *Packet);
#line 3
static void IPP__IP__sendPkt(pack *payload);
# 3 "lib/interfaces/MyPing.nc"
static void MyPingP__MyPing__complete(uint8_t *payload);
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void TransportP__SendData__fired(void );
#line 83
static void TransportP__Retransmit__fired(void );
#line 83
static void TransportP__listenClose__fired(void );
#line 83
static void TransportP__writeTimer__fired(void );
# 151 "lib/interfaces/Transport.nc"
static error_t TransportP__Transport__listen(socket_t fd);
#line 21
static socket_t TransportP__Transport__startClient(uint8_t destination, uint8_t sourcePort, uint8_t destinationPort);
#line 87
static error_t TransportP__Transport__receive(pack *package);
#line 22
static void TransportP__Transport__removePackets(int srcPort);
#line 140
static error_t TransportP__Transport__release(socket_t fd);
#line 104
...
#line 20
static void TransportP__Transport__startServer(uint8_t port);
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void TransportP__LongClose__fired(void );
#line 83
static void TransportP__Close__fired(void );
# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
static 
#line 78
/*TransportC.oldPackets*/QueueC__1__Queue__t  

/*TransportC.oldPackets*/QueueC__1__Queue__head(void );
#line 97
static error_t /*TransportC.oldPackets*/QueueC__1__Queue__enqueue(
#line 93
/*TransportC.oldPackets*/QueueC__1__Queue__t  newVal);
#line 72
static uint8_t /*TransportC.oldPackets*/QueueC__1__Queue__maxSize(void );
#line 88
static 
#line 86
/*TransportC.oldPackets*/QueueC__1__Queue__t  

/*TransportC.oldPackets*/QueueC__1__Queue__dequeue(void );
#line 50
static bool /*TransportC.oldPackets*/QueueC__1__Queue__empty(void );
#line 65
static uint8_t /*TransportC.oldPackets*/QueueC__1__Queue__size(void );
# 5 "lib/interfaces/Chat.nc"
static void ChatP__Chat__setSocket(socket_t fd, uint8_t *temp);
#line 4
static void ChatP__Chat__startChatClient(uint8_t destination, uint8_t sourcePort, uint8_t destinationPort, uint8_t *transfer);

static void ChatP__Chat__handleMsg(socket_t fd, uint8_t *temp);
#line 3
static void ChatP__Chat__startChatServer(uint8_t port);



static void ChatP__Chat__clientHandleMsg(uint8_t *msg);
...
static void Node__LinkState__printRoutingTable(uint16_t node);
#line 2
static void Node__LinkState__run(void );
...
# 4 "lib/interfaces/Chat.nc"
static void Node__Chat__startChatClient(uint8_t destination, uint8_t sourcePort, uint8_t destinationPort, uint8_t *transfer);
#line 3
static void Node__Chat__startChatServer(uint8_t port);
# 39 "Node.nc"
...
static inline void Node__CommandHandler__printRouteTable(uint16_t destination);
...
static inline void Node__CommandHandler__setTestClient(uint8_t destination, uint8_t sourcePort, uint8_t destinationPort, uint8_t *transfer);
# 89 "/opt/tinyos-main/tos/interfaces/Pool.nc"
...
static void CommandHandlerP__CommandHandler__setTestClient(uint8_t destination, uint8_t sourcePort, uint8_t destinationPort, uint8_t *transfer);
#line 8
static void CommandHandlerP__CommandHandler__setTestServer(uint8_t port);
#line 5
static void CommandHandlerP__CommandHandler__printRouteTable(uint16_t destination);
#line 3
...
static void NeighborDiscoveryP__LinkState__update(void );
# 3 "lib/interfaces/LinkLayer.nc"
static void NeighborDiscoveryP__Link__repack(uint16_t src, uint16_t dest, pack payload);
# 26 "lib/modules/NeighborDiscoveryP.nc"
pack NeighborDiscoveryP__NDPackage[1000];
pack NeighborDiscoveryP__NDReturn[1000];
static void NeighborDiscoveryP__package(pack *Package, uint16_t seq, uint8_t TTL, uint8_t protocol, uint8_t *payload);

struct NeighborStats NeighborDiscoveryP__NeighborTable[1000][20];

static inline void NeighborDiscoveryP__initTable(void );
#line 44
static void NeighborDiscoveryP__updateNT(void );
#line 60
static void NeighborDiscoveryP__NeighborDiscovery__printNeighbors(void );
...
static void NeighborDiscoveryP__NeighborDiscovery__response(pack *request, uint16_t source);
#line 103
static inline void NeighborDiscoveryP__NeighborDiscovery__newStats(pack *packet);
...
static inline uint8_t NeighborDiscoveryP__NeighborDiscovery__getIsNeighbor(int x);
# 3 "lib/interfaces/IP.nc"
static void LinkLayerP__IP__sendPkt(pack *payload);
# 4 "lib/interfaces/SimpleSend.nc"
static error_t LinkLayerP__sendPKG__send(pack msg, uint16_t dest);
# 3 "lib/interfaces/NeighborDiscovery.nc"
static void LinkLayerP__ND__response(pack *request, uint16_t source);
# 3 "lib/interfaces/Flooding.nc"
static void LinkLayerP__Flood__control(pack *Fpacket);
# 15 "lib/modules/LinkLayerP.nc"
static inline void LinkLayerP__repackage(pack *Package, uint16_t src);




static inline void LinkLayerP__LinkLayer__repack(uint16_t src, uint16_t dest, pack payload);
...
static inline message_t *LinkLayerP__receivePKG__receive(message_t *msg, void *payload, uint8_t len);
#line 64
static inline void LinkLayerP__LinkLayer__unpackND(pack *msg);



static inline void LinkLayerP__LinkLayer__unpackF(pack *msg);



static inline void LinkLayerP__repackage(pack *Package, uint16_t src);
# 5 "lib/interfaces/NeighborDiscovery.nc"
static uint8_t FloodingP__Neighbors__getIsNeighbor(int x);
# 3 "lib/interfaces/LinkLayer.nc"
static void FloodingP__Link__repack(uint16_t src, uint16_t dest, pack payload);
# 3 "lib/interfaces/LinkState.nc"
static void FloodingP__LinkState__fill(uint16_t src, uint8_t *payload);
# 17 "lib/modules/FloodingP.nc"
uint16_t FloodingP__Fsequence[1000];
pack FloodingP__FPackage[1000];
static void FloodingP__package(pack *Package, uint16_t src, uint16_t dest, uint16_t seq, uint8_t TTL, uint8_t protocol, uint8_t *payload);
struct NodeTable FloodingP__nodeSeq[1000][20];
static inline void FloodingP__initSeq(void );
...
static inline void FloodingP__Flooding__Flood(uint16_t dest, uint8_t protocol, uint8_t *payload);
...
static void FloodingP__package(pack *Package, uint16_t src, uint16_t dest, uint16_t seq, uint8_t TTL, uint8_t protocol, uint8_t *payload);
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
static uint16_t LinkStateP__Random__rand16(void );
# 5 "lib/interfaces/NeighborDiscovery.nc"
static uint8_t LinkStateP__ND__getIsNeighbor(int x);
# 2 "lib/interfaces/Flooding.nc"
static void LinkStateP__Flood__Flood(uint16_t dest, uint8_t protocol, uint8_t *payload);
# 64 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void LinkStateP__Delay__startPeriodic(uint32_t dt);
...
static void LinkStateP__Delay__startOneShot(uint32_t dt);
# 25 "lib/modules/LinkStateP.nc"
uint8_t LinkStateP__stab[1000];
struct nodeGraph LinkStateP__graph[1000][19][19];
struct routing LinkStateP__confirmed[1000][19 + 1];
struct routing LinkStateP__tentative[1000][19 + 1];

static void LinkStateP__initGraph(void );
#line 43
static void LinkStateP__initRT(void );
#line 61
static void LinkStateP__printRoutingTable(uint8_t node);
#line 73
static inline void LinkStateP__LinkState__run(void );
...
static void LinkStateP__LinkState__update(void );
#line 112
static inline void LinkStateP__Delay__fired(void );
#line 142
static inline void LinkStateP__LinkState__fill(uint16_t src, uint8_t *payload);
...
static inline void LinkStateP__LinkState__SP(void );
#line 208
static inline void LinkStateP__LinkState__printRoutingTable(uint16_t node);



static inline uint16_t LinkStateP__LinkState__getNext(uint16_t dest);
# 97 "/opt/tinyos-main/tos/interfaces/Pool.nc"
static 
#line 94
/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__t * 


/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__get(void );
#line 61
static bool /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__empty(void );
#line 89
static error_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__put(
#line 85
/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__t * newVal);
# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
static 
#line 78
/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t  

/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__head(void );
#line 97
static error_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__enqueue(
#line 93
/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t  newVal);
#line 88
static 
#line 86
/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t  

/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__dequeue(void );
#line 50
static bool /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__empty(void );
# 126 "/opt/tinyos-main/tos/interfaces/Packet.nc"
static 
#line 123
void * 
...
/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Packet__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static error_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
static uint16_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Random__rand16(void );
# 67 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
static error_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask__postTask(void );
# 92 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static bool /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__isRunning(void );
#line 73
static void /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__startOneShot(uint32_t dt);
# 74 "lib/modules/SimpleSendP.nc"
enum /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1____nesc_unnamed4354 {
#line 74
  SimpleSendP__1__sendBufferTask = 10U
};
#line 74
typedef int /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1____nesc_sillytask_sendBufferTask[/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask];
#line 31
bool /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[1000];
message_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[1000];

static inline error_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__send(uint16_t src, uint16_t dest, pack *message);



static void /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__postSendTask(void );
...
static error_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__SimpleSend__send(pack msg, uint16_t dest);
#line 74
static inline void /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask__runTask(void );
#line 103
static inline void /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__fired(void );
#line 118
static inline error_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__send(uint16_t src, uint16_t dest, pack *message);
#line 150
static inline void /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__AMSend__sendDone(message_t *msg, error_t error);
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static void /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main/tos/interfaces/Send.nc"
static error_t /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-main/tos/interfaces/AMPacket.nc"
static void /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-main/tos/system/AMQueueEntryP.nc"
static inline error_t /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
# 60 "/opt/tinyos-main/tos/system/PoolP.nc"
uint8_t /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[1000];
uint8_t /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[1000];
/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t * /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[1000][20];
/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool[1000][20];

static inline error_t /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Init__init(void );
...
static inline bool /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__empty(void );
#line 88
static inline /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t */*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__get(void );
#line 103
static inline error_t /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__put(/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t *newVal);
# 48 "/opt/tinyos-main/tos/system/QueueC.nc"
/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue_t  /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue[1000][20];
uint8_t /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__head[1000];
uint8_t /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__tail[1000];
uint8_t /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__size[1000];

static inline bool /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__empty(void );
...
static inline uint8_t /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__size(void );



static inline uint8_t /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__maxSize(void );



static inline /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue_t /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__head(void );



static void /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__printQueue(void );
#line 89
static inline /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue_t /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__dequeue(void );
#line 101
static inline error_t /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__enqueue(/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue_t newVal);
# 3 "lib/interfaces/MyPing.nc"
static void IPP__MyPing__complete(uint8_t *payload);
# 6 "lib/interfaces/LinkState.nc"
static uint16_t IPP__LinkState__getNext(uint16_t dest);
# 3 "lib/interfaces/LinkLayer.nc"
static void IPP__Link__repack(uint16_t src, uint16_t dest, pack payload);
# 87 "lib/interfaces/Transport.nc"
static error_t IPP__Transport__receive(pack *package);
# 15 "lib/modules/IPP.nc"
pack IPP__IPPkt[1000];
static void IPP__packIt(pack *IPPacket, uint16_t src, uint16_t dest, uint8_t protocol, uint8_t *payload);

static inline void IPP__IP__build(uint16_t src, uint16_t dest, uint8_t protocol, uint8_t *payload);
...
static void IPP__IP__sendPkt(pack *payload);
#line 38
static inline void IPP__IP__sortReply(pack *Packet);
#line 53
static void IPP__packIt(pack *IPPacket, uint16_t src, uint16_t dest, uint8_t protocol, uint8_t *payload);
# 16 "lib/modules/MyPingP.nc"
static inline void MyPingP__MyPing__complete(uint8_t *payload);
# 64 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void TransportP__SendData__startPeriodic(uint32_t dt);
#line 136
static uint32_t TransportP__Retransmit__getNow(void );
#line 64
static void TransportP__Retransmit__startPeriodic(uint32_t dt);
#line 78
static void TransportP__Retransmit__stop(void );
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
static uint16_t TransportP__Random__rand16(void );
# 97 "/opt/tinyos-main/tos/interfaces/Queue.nc"
static error_t TransportP__oldPackets__enqueue(
#line 93
TransportP__oldPackets__t  newVal);
#line 88
static 
#line 86
TransportP__oldPackets__t  

TransportP__oldPackets__dequeue(void );
#line 65
static uint8_t TransportP__oldPackets__size(void );
# 64 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void TransportP__LongClose__startPeriodic(uint32_t dt);
...
static void TransportP__LongClose__startOneShot(uint32_t dt);
#line 73
static void TransportP__Close__startOneShot(uint32_t dt);
# 5 "lib/interfaces/Chat.nc"
static void TransportP__Chat__setSocket(socket_t fd, uint8_t *temp);
static void TransportP__Chat__handleMsg(socket_t fd, uint8_t *temp);
static void TransportP__Chat__clientHandleMsg(uint8_t *msg);
# 2 "lib/interfaces/IP.nc"
static void TransportP__IP__build(uint16_t src, uint16_t dest, uint8_t protocol, uint8_t *payload);
# 22 "lib/modules/TransportP.nc"
bool TransportP__availPort[1000][256];
socket_store_t TransportP__sockets[1000][MAX_NUM_OF_SOCKETS];
tcpPack TransportP__tPackage[1000];
static void TransportP__tcpPackage(tcpPack *Package, uint16_t src, uint16_t srcPort, uint16_t destPort, uint16_t seq, uint8_t ack, uint8_t flags, uint8_t adWindow, uint8_t data, uint8_t *payload);

static inline void TransportP__writeTimer__fired(void );
#line 50
static inline void TransportP__listenClose__fired(void );
#line 62
static inline void TransportP__Retransmit__fired(void );
#line 115
static inline void TransportP__Close__fired(void );
#line 127
static inline void TransportP__LongClose__fired(void );
#line 139
static inline void TransportP__SendData__fired(void );
#line 185
static inline void TransportP__Transport__removePackets(int srcPort);
#line 200
static inline void TransportP__Transport__startServer(uint8_t port);
#line 213
static inline socket_t TransportP__Transport__startClient(uint8_t destination, uint8_t sourcePort, uint8_t destinationPort);
#line 233
static socket_t TransportP__Transport__socket(void );
#line 246
static error_t TransportP__Transport__bind(socket_t fd, socket_addr_t *addr);
...
static void TransportP__tcpPackage(tcpPack *Package, uint16_t src, uint16_t srcPort, uint16_t destPort, uint16_t seq, uint8_t ack, uint8_t flags, uint8_t adWindow, uint8_t data, uint8_t *payload);
# 48 "/opt/tinyos-main/tos/system/QueueC.nc"
/*TransportC.oldPackets*/QueueC__1__queue_t  /*TransportC.oldPackets*/QueueC__1__queue[1000][64];
uint8_t /*TransportC.oldPackets*/QueueC__1__head[1000];
uint8_t /*TransportC.oldPackets*/QueueC__1__tail[1000];
uint8_t /*TransportC.oldPackets*/QueueC__1__size[1000];

static inline bool /*TransportC.oldPackets*/QueueC__1__Queue__empty(void );
...
static inline uint8_t /*TransportC.oldPackets*/QueueC__1__Queue__size(void );



static inline uint8_t /*TransportC.oldPackets*/QueueC__1__Queue__maxSize(void );



static inline /*TransportC.oldPackets*/QueueC__1__queue_t /*TransportC.oldPackets*/QueueC__1__Queue__head(void );



static void /*TransportC.oldPackets*/QueueC__1__printQueue(void );
#line 89
static /*TransportC.oldPackets*/QueueC__1__queue_t /*TransportC.oldPackets*/QueueC__1__Queue__dequeue(void );
#line 101
static error_t /*TransportC.oldPackets*/QueueC__1__Queue__enqueue(/*TransportC.oldPackets*/QueueC__1__queue_t newVal);
# 21 "lib/interfaces/Transport.nc"
static socket_t ChatP__Transport__startClient(uint8_t destination, uint8_t sourcePort, uint8_t destinationPort);
#line 77
static uint16_t ChatP__Transport__write(socket_t fd, uint8_t *buff, uint16_t bufflen);
#line 20
static void ChatP__Transport__startServer(uint8_t port);
# 19 "lib/modules/ChatP.nc"
struct users ChatP__usrs[1000][10];

static uint8_t *ChatP__concat(uint8_t *str1, uint8_t *str2);
#line 39
static inline void ChatP__Chat__startChatServer(uint8_t port);





static inline void ChatP__Chat__clientHandleMsg(uint8_t *msg);



static inline void ChatP__Chat__setSocket(socket_t fd, uint8_t *temp);
#line 67
static inline void ChatP__Chat__handleMsg(socket_t fd, uint8_t *temp);
#line 107
static inline void ChatP__Chat__startChatClient(uint8_t destination, uint8_t sourcePort, uint8_t destinationPort, uint8_t *transfer);
...
# 3 "lib/interfaces/IP.nc"
inline static void LinkLayerP__IP__sendPkt(pack *payload){
#line 3
  IPP__IP__sendPkt(payload);
#line 3
}
#line 3
# 3 "lib/interfaces/Flooding.nc"
inline static void LinkLayerP__Flood__control(pack *Fpacket){
#line 3
  FloodingP__Flooding__control(Fpacket);
#line 3
}
#line 3
# 68 "lib/modules/LinkLayerP.nc"
static inline void LinkLayerP__LinkLayer__unpackF(pack *msg)
#line 68
{
  LinkLayerP__Flood__control(msg);
}
...
# 3 "lib/interfaces/NeighborDiscovery.nc"
inline static void LinkLayerP__ND__response(pack *request, uint16_t source){
#line 3
  NeighborDiscoveryP__NeighborDiscovery__response(request, source);
#line 3
}
#line 3
# 64 "lib/modules/LinkLayerP.nc"
static inline void LinkLayerP__LinkLayer__unpackND(pack *msg)
#line 64
{
  LinkLayerP__ND__response(msg, __nesc_ntoh_uint16(msg->src.nxdata));
}
...
#line 34
      ...
      switch (__nesc_ntoh_uint8(myMsg->protocol.nxdata)) {
          case PROTOCOL_PING: 
            LinkLayerP__LinkLayer__unpackND(myMsg);
          break;
          case PROTOCOL_PINGREPLY: 
            LinkLayerP__LinkLayer__unpackND(myMsg);
          break;
          case PROTOCOL_FLOOD: 
            LinkLayerP__LinkLayer__unpackF(myMsg);
          break;
          case PROTOCOL_LINKSTATE: 
            LinkLayerP__LinkLayer__unpackF(myMsg);
          break;
          case PROTOCOL_MY_PING: 
            LinkLayerP__IP__sendPkt(myMsg);
          break;
          case PROTOCOL_TCP: 
            LinkLayerP__IP__sendPkt(myMsg);
          break;
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f1c09754e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f1c09754e30) {
#line 78
    case 6:
#line 78
...
#line 78
    case 50:
#line 78
      __nesc_result = LinkLayerP__receivePKG__receive(msg, payload, len);
#line 78
      break;
#line 78
    case 99:
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f1c09754e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 75
{
  sim_log_debug(202U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()]);
  return /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()] == 0;
}

# 61 "/opt/tinyos-main/tos/interfaces/Pool.nc"
inline static bool /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__empty(void ){
#line 61
  unsigned char __nesc_result;
#line 61

#line 61
  __nesc_result = /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__empty();
#line 61
...
#line 88
{
  if (/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()]) {
      /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t *rval = /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[sim_node()][/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()]];

#line 91
      /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[sim_node()][/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()]] = (void *)0;
      /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()]--;
      /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()]++;
      if (/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()] == 20) {
          /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()] = 0;
        }
...
# 97 "/opt/tinyos-main/tos/interfaces/Pool.nc"
inline static /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__t * /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__get(void ){
#line 97
  struct sendInfo *__nesc_result;
#line 97

#line 97
  __nesc_result = /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__get();
#line 97
...
#line 61
{
  return /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__size[sim_node()];
}
...
#line 101
{
  if (/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__size() < /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__maxSize()) {
      sim_log_debug(212U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__size[sim_node()]);
      /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue[sim_node()][/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__tail[sim_node()]] = newVal;
      /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__tail[sim_node()]++;
      if (/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__tail[sim_node()] == 20) {
#line 106
        /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__tail[sim_node()] = 0;
        }
#line 107
      /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__size[sim_node()]++;
      /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__printQueue();
      return SUCCESS;
    }
  else {
      return FAIL;
...
# 97 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static error_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__enqueue(/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t  newVal){
#line 97
  unsigned char __nesc_result;
#line 97

#line 97
  __nesc_result = /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__enqueue(newVal);
#line 97
...
# 92 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static bool /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
# 73 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__startOneShot(uint32_t dt){
#line 73
...
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
inline static uint16_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Random__rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 52
# 4 "lib/interfaces/LinkState.nc"
inline static void NeighborDiscoveryP__LinkState__update(void ){
#line 4
  LinkStateP__LinkState__update();
#line 4
}
#line 4
...
#line 103
{
  NeighborDiscoveryP__NeighborTable[sim_node()][__nesc_ntoh_uint16(packet->src.nxdata)].lastSeq = __nesc_ntoh_uint16(packet->seq.nxdata);
  NeighborDiscoveryP__NeighborTable[sim_node()][__nesc_ntoh_uint16(packet->src.nxdata)].neighborAddr = __nesc_ntoh_uint16(packet->src.nxdata);
  NeighborDiscoveryP__NeighborTable[sim_node()][__nesc_ntoh_uint16(packet->src.nxdata)].TTL = 5;
  if (NeighborDiscoveryP__NeighborTable[sim_node()][__nesc_ntoh_uint16(packet->src.nxdata)].isNeighbor != 1) {
      NeighborDiscoveryP__NeighborTable[sim_node()][__nesc_ntoh_uint16(packet->src.nxdata)].isNeighbor = 1;
      NeighborDiscoveryP__LinkState__update();
      NeighborDiscoveryP__updateNT();
    }
}

# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
inline static uint16_t LinkStateP__Random__rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 52
# 73 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void LinkStateP__Delay__startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startOneShot(2U, dt);
#line 73
}
#line 73
# 142 "lib/modules/LinkStateP.nc"
static inline void LinkStateP__LinkState__fill(uint16_t src, uint8_t *payload)
#line 142
{
  int i;
  ...
  for (i = 0; i < 19; i++) {
      LinkStateP__graph[sim_node()][payload[0] - 1][i].cost = payload[i + 1];
    }
}

# 3 "lib/interfaces/LinkState.nc"
inline static void FloodingP__LinkState__fill(uint16_t src, uint8_t *payload){
#line 3
  LinkStateP__LinkState__fill(src, payload);
#line 3
}
#line 3
...
#line 121
{
  return NeighborDiscoveryP__NeighborTable[sim_node()][x].isNeighbor;
}

# 5 "lib/interfaces/NeighborDiscovery.nc"
inline static uint8_t FloodingP__Neighbors__getIsNeighbor(int x){
#line 5
  unsigned char __nesc_result;
#line 5

#line 5
  __nesc_result = NeighborDiscoveryP__NeighborDiscovery__getIsNeighbor(x);
#line 5
...
#line 5
# 4 "lib/interfaces/SimpleSend.nc"
inline static error_t LinkLayerP__sendPKG__send(pack msg, uint16_t dest){
#line 4
  unsigned char __nesc_result;
#line 4

#line 4
  __nesc_result = /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__SimpleSend__send(msg, dest);
#line 4
...
#line 20
{
  ...
  LinkLayerP__repackage(&payload, src);

  LinkLayerP__sendPKG__send(payload, dest);
}

# 3 "lib/interfaces/LinkLayer.nc"
inline static void FloodingP__Link__repack(uint16_t src, uint16_t dest, pack payload){
#line 3
  LinkLayerP__LinkLayer__repack(src, dest, payload);
#line 3
}
#line 3
...
#line 18
{
  IPP__packIt(&IPP__IPPkt[sim_node()], src, dest, protocol, payload);

  IPP__IP__sendPkt(&IPP__IPPkt[sim_node()]);
}

# 2 "lib/interfaces/IP.nc"
inline static void TransportP__IP__build(uint16_t src, uint16_t dest, uint8_t protocol, uint8_t *payload){
#line 2
  IPP__IP__build(src, dest, protocol, payload);
#line 2
}
#line 2
# 64 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void TransportP__LongClose__startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startPeriodic(6U, dt);
#line 64
}
#line 64
inline static void TransportP__Retransmit__startPeriodic(uint32_t dt){
#line 64
...
#line 64
# 97 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static error_t TransportP__oldPackets__enqueue(TransportP__oldPackets__t  newVal){
#line 97
  unsigned char __nesc_result;
#line 97

#line 97
  __nesc_result = /*TransportC.oldPackets*/QueueC__1__Queue__enqueue(newVal);
#line 97
...
#line 97
#line 88
inline static TransportP__oldPackets__t  TransportP__oldPackets__dequeue(void ){
#line 88
  nx_struct tcpPack __nesc_result;
#line 88

#line 88
  __nesc_result = /*TransportC.oldPackets*/QueueC__1__Queue__dequeue();
#line 88
...
#line 61
{
  return /*TransportC.oldPackets*/QueueC__1__size[sim_node()];
}

# 65 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static uint8_t TransportP__oldPackets__size(void ){
#line 65
  unsigned char __nesc_result;
#line 65

#line 65
  __nesc_result = /*TransportC.oldPackets*/QueueC__1__Queue__size();
#line 65
...
#line 65
# 185 "lib/modules/TransportP.nc"
static inline void TransportP__Transport__removePackets(int srcPort)
#line 185
{
  int i;
#line 186
  int queueSize = TransportP__oldPackets__size();
  tcpPack temp;

#line 188
  sim_log_debug(222U, TRANSPORT_CHANNEL, "IN REMOVE PACKETS\n");
  for (i = 0; i < queueSize; i++) {
      temp = TransportP__oldPackets__dequeue();
      if (__nesc_ntoh_uint8(temp.srcPort.nxdata) == srcPort) {
        }
      else {
          TransportP__oldPackets__enqueue(temp);
        }
    }
  TransportP__Retransmit__startPeriodic(500);
}
...
inline static void TransportP__Retransmit__stop(void ){
#line 78
...
#line 78
#line 73
inline static void TransportP__LongClose__startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startOneShot(6U, dt);
#line 73
}
#line 73
# 45 "lib/modules/ChatP.nc"
static inline void ChatP__Chat__clientHandleMsg(uint8_t *msg)
#line 45
{
  sim_log_debug(257U, TRANSPORT_CHANNEL, "MSG: %s", msg);
}

# 7 "lib/interfaces/Chat.nc"
inline static void TransportP__Chat__clientHandleMsg(uint8_t *msg){
#line 7
  ChatP__Chat__clientHandleMsg(msg);
#line 7
}
#line 7
# 77 "lib/interfaces/Transport.nc"
...
#line 70
  if (*temp == "m") {
      cmd = strtok(temp, " ");
      msg = strtok((void *)0, "\r\n");
      fin = ChatP__concat(usr, msg);
      for (i = 0; i < 10; i++) {
          if (ChatP__usrs[sim_node()][i].name[0] != (void *)0) {

              ChatP__Transport__write(ChatP__usrs[sim_node()][i].fd, *fin, strlen((const uint8_t *)fin));
            }
        }
    }
  else {
#line 80
    if (*temp == "w") {
        ...
        fin = ChatP__concat(usr, msg);
        for (i = 0; i < 10; i++) {
            if (!strcmp(usr, ChatP__usrs[sim_node()][i].name)) {
...
#line 92
      if (*temp == "l") {
          fin = ChatP__concat(fin, "listUsrRply: ");
          for (i = 0; i < 10; i++) {
              if (ChatP__usrs[sim_node()][i].name[0] != (void *)0) {
                  fin = ChatP__concat(fin, ChatP__usrs[sim_node()][i].name);
                  fin = ChatP__concat(fin, ", ");
                }
            }
          fin = ChatP__concat(fin, "\r\n");
          ChatP__Transport__write(fd, *fin, strlen((const uint8_t *)fin));
        }
      else 
#line 102
        {
...
inline static void TransportP__Chat__handleMsg(socket_t fd, uint8_t *temp){
#line 6
  ChatP__Chat__handleMsg(fd, temp);
#line 6
}
#line 6
...
#line 53
  ...
  usr = strtok((void *)0, delim);
  msg = strtok((void *)0, msgDelim);
  port = (uint8_t )msg[0];
  fin = ChatP__concat(cmd, usr);
  sim_log_debug(258U, TRANSPORT_CHANNEL, "IN SET SOCKET: %.*s\n", strlen((const uint8_t *)fin), fin);
  memcpy(ChatP__usrs[sim_node()][port].name, usr, strlen((const uint8_t *)usr));
  sim_log_debug(259U, TRANSPORT_CHANNEL, "usrs: %s\n", ChatP__usrs[sim_node()][port].name);
  ChatP__usrs[sim_node()][port].fd = fd;
}

# 5 "lib/interfaces/Chat.nc"
inline static void TransportP__Chat__setSocket(socket_t fd, uint8_t *temp){
#line 5
  ChatP__Chat__setSocket(fd, temp);
#line 5
}
#line 5
# 528 "lib/modules/TransportP.nc"
static inline uint16_t TransportP__Transport__read(socket_t fd, uint8_t *buff, uint16_t bufflen)
#line 528
{
  char temp[bufflen];
...
#line 531
  sim_log_debug(243U, TRANSPORT_CHANNEL, "IN READ: %s | %d, %d\n", buff, fd, bufflen);
  ...
  if (temp[0] == 'h' && __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata) == 41 && TOS_NODE_ID == 1) {
      TransportP__Chat__setSocket(fd, temp);
    }
  else {
#line 540
    if (__nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata) == 41 && TOS_NODE_ID == 1) {
        TransportP__Chat__handleMsg(fd, temp);
      }
    else 
#line 542
      {
        TransportP__Chat__clientHandleMsg(temp);
      }
    }
  ...
  for (i = 0; i < bufflen; i++) {
      TransportP__sockets[sim_node()][fd - 1].rcvdBuff[i] = (void *)0;
      TransportP__sockets[sim_node()][fd - 1].bufflen -= 1;
    }
}
...
# 136 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static uint32_t TransportP__Retransmit__getNow(void ){
#line 136
  unsigned int __nesc_result;
#line 136
...
#line 264
{
  ...
  if (TransportP__sockets[sim_node()][fd - 1].state == LISTEN) {
      ...
      __nesc_hton_uint16(TransportP__sockets[sim_node()][newFD - 1].src.addr.nxdata, __nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata));
      __nesc_hton_uint8(TransportP__sockets[sim_node()][newFD - 1].src.port.nxdata, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata));
      TransportP__sockets[sim_node()][newFD - 1].state = SYN_RCVD;
      TransportP__sockets[sim_node()][newFD - 1].flag = 1;
      TransportP__sockets[sim_node()][newFD - 1].effectiveWindow = SOCKET_BUFFER_SIZE;

      TransportP__sockets[sim_node()][fd - 1].sendBuff[0] = (void *)0;
    }
  else 
#line 278
    {
      for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
          if (TransportP__sockets[sim_node()][i].state == SYN_RCVD) {
              newFD = i + 1;
            }
        }
    }
  for (i = 0; i < SOCKET_BUFFER_SIZE; i++) {
      TransportP__sockets[sim_node()][newFD - 1].rcvdBuff[i] = (void *)0;
    }



  sim_log_debug(226U, PROJECT3TGEN, "ACCEPTING CONNECTION\n");
  return newFD;
}
...
#line 332
  sim_log_debug(229U, PROJECT3TGEN, "RECEIVED: %d, %d, %d, %d, %d, %d, %d, %.8s\n", __nesc_ntoh_uint8(newPack->srcPort.nxdata), __nesc_ntoh_uint8(newPack->destPort.nxdata), __nesc_ntoh_uint16(newPack->seq.nxdata), __nesc_ntoh_uint8(newPack->ack.nxdata), __nesc_ntoh_uint8(newPack->flags.nxdata), __nesc_ntoh_uint8(newPack->adWindow.nxdata), __nesc_ntoh_uint8(newPack->data.nxdata), newPack->payload);
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      if (__nesc_ntoh_uint8(newPack->flags.nxdata) == 1 && __nesc_ntoh_uint8(TransportP__sockets[sim_node()][i].src.port.nxdata) == __nesc_ntoh_uint8(newPack->destPort.nxdata) && i == 0) {
          fd = i + 1;
        }

      if (__nesc_ntoh_uint8(TransportP__sockets[sim_node()][i].src.port.nxdata) == __nesc_ntoh_uint8(newPack->destPort.nxdata) && __nesc_ntoh_uint8(TransportP__sockets[sim_node()][i].dest.port.nxdata) == __nesc_ntoh_uint8(newPack->srcPort.nxdata)) {
          fd = i + 1;
        }
    }
  sim_log_debug(230U, TRANSPORT_CHANNEL, "-------FD------- %d, %d, %d, %d, %d\n", fd, __nesc_ntoh_uint8(newPack->destPort.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(newPack->srcPort.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata));


  switch (__nesc_ntoh_uint8(newPack->flags.nxdata)) {
      case 1: 
        if (TransportP__sockets[sim_node()][fd - 1].nextExpected == 0) {
            newFD = TransportP__Transport__accept(fd);
            TransportP__sockets[sim_node()][newFD - 1].state = SYN_RCVD;
            TransportP__sockets[sim_node()][newFD - 1].lastRcvd = __nesc_ntoh_uint16(newPack->seq.nxdata);
            TransportP__sockets[sim_node()][newFD - 1].nextExpected = __nesc_ntoh_uint16(newPack->seq.nxdata) + 2;
            __nesc_hton_uint16(TransportP__sockets[sim_node()][newFD - 1].dest.addr.nxdata, (uint8_t )newPack->payload);
            __nesc_hton_uint8(TransportP__sockets[sim_node()][newFD - 1].dest.port.nxdata, __nesc_ntoh_uint8(newPack->srcPort.nxdata));
            TransportP__sockets[sim_node()][newFD - 1].lastFlag = 5;
            TransportP__sockets[sim_node()][newFD - 1].lastSent = TransportP__Random__rand16() % 120;
            TransportP__sockets[sim_node()][newFD - 1].seq = TransportP__Random__rand16() % 120;
            TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][newFD - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][newFD - 1].dest.port.nxdata), TransportP__sockets[sim_node()][newFD - 1].seq, TransportP__sockets[sim_node()][newFD - 1].lastRcvd + 1, 2, TransportP__sockets[sim_node()][fd - 1].effectiveWindow, 0, "");
            TransportP__IP__build(__nesc_ntoh_uint16(TransportP__sockets[sim_node()][newFD - 1].src.addr.nxdata), __nesc_ntoh_uint16(newPack->src.nxdata), PROTOCOL_TCP, &TransportP__tPackage[sim_node()]);
            sim_log_debug(231U, PROJECT3TGEN, "next exp: %d\n", TransportP__sockets[sim_node()][fd - 1].nextExpected);

            sim_log_debug(232U, TRANSPORT_CHANNEL, "-------FD------- %d, %d, %d, %d, %d\n", newFD, __nesc_ntoh_uint8(newPack->destPort.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][newFD - 1].src.port.nxdata), __nesc_ntoh_uint8(newPack->srcPort.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][newFD - 1].dest.port.nxdata));
            flag = SUCCESS;
          }
        else 
#line 363
          {
            TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), 
            TransportP__sockets[sim_node()][fd - 1].seq, TransportP__sockets[sim_node()][fd - 1].lastRcvd, 7, TransportP__sockets[sim_node()][fd - 1].effectiveWindow, 0, "");
            TransportP__IP__build(__nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata), __nesc_ntoh_uint16(newPack->src.nxdata), PROTOCOL_TCP, &TransportP__tPackage[sim_node()]);
          }
      break;
      case 2: 
        TransportP__sockets[sim_node()][fd - 1].lastRcvd = __nesc_ntoh_uint16(newPack->seq.nxdata);
      TransportP__sockets[sim_node()][fd - 1].lastSent = __nesc_ntoh_uint8(newPack->ack.nxdata);
      TransportP__sockets[sim_node()][fd - 1].lastAck = __nesc_ntoh_uint8(newPack->ack.nxdata);
      TransportP__sockets[sim_node()][fd - 1].effectiveWindow = __nesc_ntoh_uint8(newPack->adWindow.nxdata);
      TransportP__sockets[sim_node()][fd - 1].RTT = TransportP__Retransmit__getNow() - TransportP__sockets[sim_node()][fd - 1].RTT;
      sim_log_debug(233U, PROJECT3TGEN, "RTT TIMER: %d\n", TransportP__sockets[sim_node()][fd - 1].RTT);
      TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), TransportP__sockets[sim_node()][fd - 1].lastSent + 1, TransportP__sockets[sim_node()][fd - 1].lastRcvd + 1, 3, TransportP__sockets[sim_node()][fd - 1].effectiveWindow, 0, "");
      TransportP__IP__build(__nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata), __nesc_ntoh_uint16(newPack->src.nxdata), PROTOCOL_TCP, &TransportP__tPackage[sim_node()]);
      TransportP__sockets[sim_node()][fd - 1].lastSent += 1;
#line 378
      ;
      TransportP__oldPackets__enqueue(TransportP__tPackage[sim_node()]);

      sim_log_debug(234U, TRANSPORT_CHANNEL, "CONNECTION ESTABLISHED!\n");
      ...
      break;
      case 3: 
        if (__nesc_ntoh_uint16(newPack->seq.nxdata) == TransportP__sockets[sim_node()][fd - 1].nextExpected) {
            TransportP__sockets[sim_node()][fd - 1].lastRcvd = __nesc_ntoh_uint16(newPack->seq.nxdata);

            TransportP__sockets[sim_node()][fd - 1].nextExpected = __nesc_ntoh_uint16(newPack->seq.nxdata) + 1;

            sim_log_debug(235U, TRANSPORT_CHANNEL, "CONNECTION ESTABLISHED!\n");
            sim_log_debug(236U, PROJECT3TGEN, "next exp: %d\n", TransportP__sockets[sim_node()][fd - 1].nextExpected);
      ...
      case 4: 
        ...
        if (__nesc_ntoh_uint16(newPack->seq.nxdata) == TransportP__sockets[sim_node()][fd - 1].nextExpected) {
            ...
            TransportP__sockets[sim_node()][fd - 1].lastRcvd = __nesc_ntoh_uint16(newPack->seq.nxdata);
            TransportP__sockets[sim_node()][fd - 1].nextExpected = __nesc_ntoh_uint16(newPack->seq.nxdata) + 1;
            TransportP__sockets[sim_node()][fd - 1].effectiveWindow -= __nesc_ntoh_uint8(newPack->data.nxdata);
            TransportP__sockets[sim_node()][fd - 1].seq += 1;

            j = 0;
            sim_log_debug(237U, PROJECT3TGEN, "READING: %.8s\n", newPack->payload);
            for (k = 0; k < SOCKET_BUFFER_SIZE; k++) {
                if (TransportP__sockets[sim_node()][fd - 1].rcvdBuff[k] == (void *)0 && j < __nesc_ntoh_uint8(newPack->data.nxdata)) {
                    TransportP__sockets[sim_node()][fd - 1].rcvdBuff[k] = __nesc_ntoh_uint8(newPack->payload[j].nxdata);
                    j++;
                  }
              }

            TransportP__sockets[sim_node()][fd - 1].bufflen += __nesc_ntoh_uint8(newPack->data.nxdata);
            sim_log_debug(238U, TRANSPORT_CHANNEL, "RCVD BUFFER: %s | %d, %d\n", TransportP__sockets[sim_node()][fd - 1].rcvdBuff, fd, TransportP__sockets[sim_node()][fd - 1].bufflen);


            if (__nesc_ntoh_uint8(newPack->data.nxdata) > 7) {
                TransportP__sockets[sim_node()][fd - 1].lastFlag = 5;
                TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), 
                TransportP__sockets[sim_node()][fd - 1].seq, __nesc_ntoh_uint16(newPack->seq.nxdata), 5, TransportP__sockets[sim_node()][fd - 1].effectiveWindow, 0, "");
                TransportP__IP__build(__nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata), __nesc_ntoh_uint16(newPack->src.nxdata), PROTOCOL_TCP, &TransportP__tPackage[sim_node()]);
              }
            else 
#line 437
              {
                TransportP__sockets[sim_node()][fd - 1].lastFlag = 6;
                TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), 
                TransportP__sockets[sim_node()][fd - 1].seq, __nesc_ntoh_uint16(newPack->seq.nxdata), 6, TransportP__sockets[sim_node()][fd - 1].effectiveWindow, 0, "");
                TransportP__IP__build(__nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata), __nesc_ntoh_uint16(newPack->src.nxdata), PROTOCOL_TCP, &TransportP__tPackage[sim_node()]);
                TransportP__Transport__read(fd, TransportP__sockets[sim_node()][fd - 1].rcvdBuff, TransportP__sockets[sim_node()][fd - 1].bufflen);
              }
          }
        else 
          ...
          {
            TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), 
            TransportP__sockets[sim_node()][fd - 1].seq, TransportP__sockets[sim_node()][fd - 1].lastRcvd, TransportP__sockets[sim_node()][fd - 1].lastFlag, TransportP__sockets[sim_node()][fd - 1].effectiveWindow, 0, "");
            TransportP__IP__build(__nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata), __nesc_ntoh_uint16(newPack->src.nxdata), PROTOCOL_TCP, &TransportP__tPackage[sim_node()]);
          }
      ...
      case 11: 
        ...
        if (__nesc_ntoh_uint16(newPack->seq.nxdata) == TransportP__sockets[sim_node()][fd - 1].nextExpected) {
            TransportP__LongClose__startOneShot(5000);
            TransportP__sockets[sim_node()][fd - 1].state = CLOSING;
            TransportP__sockets[sim_node()][fd - 1].seq += 1;
            TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), __nesc_ntoh_uint8(newPack->ack.nxdata) + 1, __nesc_ntoh_uint16(newPack->seq.nxdata), 12, 0, 0, "");
            TransportP__sockets[sim_node()][fd - 1].nextExpected = __nesc_ntoh_uint16(newPack->seq.nxdata) + 1;
            TransportP__sockets[sim_node()][fd - 1].state = CLOSING;
            ...
            TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), __nesc_ntoh_uint8(newPack->ack.nxdata) + 1, __nesc_ntoh_uint16(newPack->seq.nxdata), 14, 0, 0, "");
            TransportP__IP__build(__nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata), __nesc_ntoh_uint16(newPack->src.nxdata), PROTOCOL_TCP, &TransportP__tPackage[sim_node()]);
            TransportP__oldPackets__enqueue(TransportP__tPackage[sim_node()]);
            TransportP__sockets[sim_node()][fd - 1].RTT = 1500;
            TransportP__Retransmit__startPeriodic(1500);
          }
        else {
            TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), 
            TransportP__sockets[sim_node()][fd - 1].seq, TransportP__sockets[sim_node()][fd - 1].lastRcvd, 12, TransportP__sockets[sim_node()][fd - 1].effectiveWindow, 0, "");
            TransportP__IP__build(__nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata), __nesc_ntoh_uint16(newPack->src.nxdata), PROTOCOL_TCP, &TransportP__tPackage[sim_node()]);
          }
      break;
      case 12: 
      ...
      case 13: 
        ...
        sim_log_debug(239U, TRANSPORT_CHANNEL, "CLOSING SERVER SOCKET\n");
      TransportP__sockets[sim_node()][fd - 1].nextExpected = __nesc_ntoh_uint16(newPack->seq.nxdata) + 1;
      sim_log_debug(240U, PROJECT3TGEN, "next exp: %d\n", TransportP__sockets[sim_node()][fd - 1].nextExpected);
      TransportP__Close__startOneShot(500);
      break;
      case 14: 
        TransportP__Retransmit__stop();
      TransportP__Transport__removePackets(__nesc_ntoh_uint8(newPack->destPort.nxdata));
      sim_log_debug(241U, TRANSPORT_CHANNEL, "CLOSING CLIENT SOCKET SOON\n");
      TransportP__LongClose__startPeriodic(1000);
      TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), __nesc_ntoh_uint8(newPack->ack.nxdata) + 1, __nesc_ntoh_uint16(newPack->seq.nxdata) + 1, 13, 0, 0, "");
      TransportP__IP__build(__nesc_ntoh_uint16(TransportP__sockets[sim_node()][newFD - 1].src.addr.nxdata), __nesc_ntoh_uint16(newPack->src.nxdata), PROTOCOL_TCP, &TransportP__tPackage[sim_node()]);
      break;
      default: 
        sim_log_debug(242U, TRANSPORT_CHANNEL, "default case - FLAG : %d\n", __nesc_ntoh_uint8(newPack->flags.nxdata));
      break;
    }

  TransportP__sockets[sim_node()][fd - 1].outstanding -= 1;
  return flag;
}
...
#line 16
{
  sim_log_debug(215U, TRANSPORT_CHANNEL, "PING COMPLETE: %s\n", payload);
}

# 3 "lib/interfaces/MyPing.nc"
inline static void IPP__MyPing__complete(uint8_t *payload){
#line 3
  MyPingP__MyPing__complete(payload);
#line 3
}
#line 3
# 38 "lib/modules/IPP.nc"
static inline void IPP__IP__sortReply(pack *Packet)
#line 38
{
  switch (__nesc_ntoh_uint8(Packet->protocol.nxdata)) {
      case PROTOCOL_MY_PING: 
        IPP__MyPing__complete(Packet->payload);
      break;
      case PROTOCOL_TCP: 

        IPP__Transport__receive(Packet->payload);
      break;
      default: 
        sim_log_debug(214U, ROUTING_CHANNEL, "IP: INTERFACE NOT IMPLEMENTED\n");
      break;
    }
}
...
# 64 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void TransportP__SendData__startPeriodic(uint32_t dt){
#line 64
...
#line 69
{
  return /*TransportC.oldPackets*/QueueC__1__queue[sim_node()][/*TransportC.oldPackets*/QueueC__1__head[sim_node()]];
}
...
#line 53
{
  return /*TransportC.oldPackets*/QueueC__1__size[sim_node()] == 0;
}

# 212 "lib/modules/LinkStateP.nc"
static inline uint16_t LinkStateP__LinkState__getNext(uint16_t dest)
#line 212
{
  return LinkStateP__confirmed[sim_node()][dest].thru;
}

# 6 "lib/interfaces/LinkState.nc"
inline static uint16_t IPP__LinkState__getNext(uint16_t dest){
#line 6
  unsigned short __nesc_result;
#line 6

#line 6
  __nesc_result = LinkStateP__LinkState__getNext(dest);
#line 6
...
#line 6
# 3 "lib/interfaces/LinkLayer.nc"
inline static void IPP__Link__repack(uint16_t src, uint16_t dest, pack payload){
#line 3
  LinkLayerP__LinkLayer__repack(src, dest, payload);
#line 3
}
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f1c09752a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f1c09752a50, msg, payload, len);
#line 78
...
#line 104
# 64 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void LinkStateP__Delay__startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startPeriodic(2U, dt);
#line 64
}
#line 64
# 73 "lib/modules/LinkStateP.nc"
static inline void LinkStateP__LinkState__run(void )
#line 73
{


  LinkStateP__initGraph();
  LinkStateP__Delay__startPeriodic(60000);
}

# 2 "lib/interfaces/LinkState.nc"
inline static void Node__LinkState__run(void ){
#line 2
  LinkStateP__LinkState__run();
#line 2
}
#line 2
# 64 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
...
#line 34
  for (i = 0; i < 20; i++) {
      NeighborDiscoveryP__NeighborTable[sim_node()][i].neighborAddr = -1;
      NeighborDiscoveryP__NeighborTable[sim_node()][i].requests = 0;
      NeighborDiscoveryP__NeighborTable[sim_node()][i].responses = 0;
      NeighborDiscoveryP__NeighborTable[sim_node()][i].isNeighbor = 0;
      NeighborDiscoveryP__NeighborTable[sim_node()][i].lastSeq = -1;
      NeighborDiscoveryP__NeighborTable[sim_node()][i].TTL = 0;
    }
}
...
#line 69
{
  sim_log_debug(180U, NEIGHBOR_CHANNEL, "starting Neighbor Discovery\n");
  NeighborDiscoveryP__initTable();
  NeighborDiscoveryP__DiscoveryTimer__startPeriodic(30000);
}
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f1c0976dc70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f1c0976dc70, msg, error);
#line 110
}
#line 110
...
#line 150
{
  ...
  if (&/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[sim_node()] == msg) {
      /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[sim_node()] = FALSE;
      /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__postSendTask();
    }
}

# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__AMSend__sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-main/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f1c090e5940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f1c090e5940) {
#line 100
    case 0U:
#line 100
...
#line 100
    case 1U:
#line 100
      /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f1c090e5940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 653
  ...
  sim_log_debug(247U, TRANSPORT_CHANNEL, "SOCKET %d LISTENING\n", fd);
  TransportP__Close__startOneShot(50000);
  return flag;
}
...
#line 203
  sim_log_debug(223U, TRANSPORT_CHANNEL, "SET TEST SERVER: %d, %d\n", TOS_NODE_ID, port);
  __nesc_hton_uint8(addr.port.nxdata, port);
  __nesc_hton_uint16(addr.addr.nxdata, TOS_NODE_ID);
  fd = TransportP__Transport__socket();
  TransportP__Transport__bind(fd, &addr);
  TransportP__Transport__listen(fd);
}

# 20 "lib/interfaces/Transport.nc"
inline static void ChatP__Transport__startServer(uint8_t port){
#line 20
  TransportP__Transport__startServer(port);
#line 20
}
#line 20
# 39 "lib/modules/ChatP.nc"
static inline void ChatP__Chat__startChatServer(uint8_t port)
#line 39
{
  sim_log_debug(256U, TRANSPORT_CHANNEL, "TEST: %d, %d\n", TOS_NODE_ID, port);
  ChatP__Transport__startServer(port);
}

# 3 "lib/interfaces/Chat.nc"
inline static void Node__Chat__startChatServer(uint8_t port){
#line 3
  ChatP__Chat__startChatServer(port);
#line 3
}
#line 3
# 96 "Node.nc"
...
#line 96
{
  Node__Chat__startChatServer(port);
}
...
#line 556
{
  ...
  TransportP__sockets[sim_node()][fd - 1].effectiveWindow = 128;
  TransportP__sockets[sim_node()][fd - 1].lastSent = TransportP__Random__rand16() % 120;
  TransportP__sockets[sim_node()][fd - 1].seq = TransportP__Random__rand16() % 120;

  TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), 
  TransportP__sockets[sim_node()][fd - 1].seq, 0, 1, 128, 0, "");
  sim_log_debug(244U, TRANSPORT_CHANNEL, "ATTEMPTING CONNECTION\n");


  TransportP__sockets[sim_node()][fd - 1].RTT = TransportP__Retransmit__getNow();
  TransportP__IP__build(__nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata), __nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].dest.addr.nxdata), PROTOCOL_TCP, &TransportP__tPackage[sim_node()]);
  TransportP__oldPackets__enqueue(TransportP__tPackage[sim_node()]);
  TransportP__sockets[sim_node()][fd - 1].outstanding += 1;
}
...
#line 218
  sim_log_debug(224U, TRANSPORT_CHANNEL, "SET TEST CLIENT: %d, %d, %d, %d\n", TOS_NODE_ID, destination, sourcePort, destinationPort);
  __nesc_hton_uint8(srcAddr.port.nxdata, sourcePort);
  __nesc_hton_uint16(srcAddr.addr.nxdata, TOS_NODE_ID);
  TransportP__Transport__bind(fd, &srcAddr);
  __nesc_hton_uint8(destAddr.port.nxdata, destinationPort);
  __nesc_hton_uint16(destAddr.addr.nxdata, destination);
  TransportP__Transport__connect(fd, &destAddr);


  TransportP__Retransmit__startPeriodic(5000);
...
# 21 "lib/interfaces/Transport.nc"
inline static socket_t ChatP__Transport__startClient(uint8_t destination, uint8_t sourcePort, uint8_t destinationPort){
#line 21
  unsigned char __nesc_result;
#line 21

#line 21
  __nesc_result = TransportP__Transport__startClient(destination, sourcePort, destinationPort);
#line 21
...
#line 113
  if (*transfer == 'h') {
      ChatP__usrs[sim_node()][sourcePort].fd = ChatP__Transport__startClient(destination, sourcePort, destinationPort);
      ChatP__Transport__write(ChatP__usrs[sim_node()][sourcePort].fd, transfer, strlength);
    }
  else 
#line 116
    {
      sim_log_debug(260U, TRANSPORT_CHANNEL, "GEN MSG\n");
      ChatP__Transport__write(ChatP__usrs[sim_node()][sourcePort].fd, transfer, strlength);
    }
}

# 4 "lib/interfaces/Chat.nc"
inline static void Node__Chat__startChatClient(uint8_t destination, uint8_t sourcePort, uint8_t destinationPort, uint8_t *transfer){
#line 4
  ChatP__Chat__startChatClient(destination, sourcePort, destinationPort, transfer);
#line 4
}
#line 4
# 100 "Node.nc"
...
#line 100
{
  Node__Chat__startChatClient(destination, sourcePort, destinationPort, transfer);
}

# 9 "lib/interfaces/CommandHandler.nc"
inline static void CommandHandlerP__CommandHandler__setTestClient(uint8_t destination, uint8_t sourcePort, uint8_t destinationPort, uint8_t *transfer){
#line 9
  Node__CommandHandler__setTestClient(destination, sourcePort, destinationPort, transfer);
#line 9
}
#line 9
# 208 "lib/modules/LinkStateP.nc"
static inline void LinkStateP__LinkState__printRoutingTable(uint16_t node)
#line 208
{
  LinkStateP__printRoutingTable(node);
}

# 8 "lib/interfaces/LinkState.nc"
inline static void Node__LinkState__printRoutingTable(uint16_t node){
#line 8
  LinkStateP__LinkState__printRoutingTable(node);
#line 8
}
#line 8
# 87 "Node.nc"
...
#line 87
{
  ...
  Node__LinkState__printRoutingTable(destination);
}

# 5 "lib/interfaces/CommandHandler.nc"
inline static void CommandHandlerP__CommandHandler__printRouteTable(uint16_t destination){
#line 5
  Node__CommandHandler__printRouteTable(destination);
#line 5
}
#line 5
# 92 "Node.nc"
...
#line 70
{
  ...
  sim_log_debug(113U, TRANSPORT_CHANNEL, "PrintOut: %s\n", payload);
}
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      switch (commandID) {
          ...
          CommandHandlerP__CommandHandler__printRouteTable(buff[0]);
          break;
...
#line 53
{
  return /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__size[sim_node()] == 0;
}

# 50 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static bool /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__empty(void ){
#line 50
  unsigned char __nesc_result;
#line 50

#line 50
  __nesc_result = /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__empty();
#line 50
...
#line 103
{
  if (/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()] >= 20) {
      return FAIL;
    }
  else {
      uint16_t emptyIndex = /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()] + /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()];

#line 109
      if (emptyIndex >= 20) {
          emptyIndex -= 20;
        }
      /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[sim_node()][emptyIndex] = newVal;
      /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()]++;
...
# 89 "/opt/tinyos-main/tos/interfaces/Pool.nc"
inline static error_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__put(/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__t * newVal){
#line 89
  unsigned char __nesc_result;
#line 89

#line 89
  __nesc_result = /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__put(newVal);
#line 89
...
#line 69
{
  return /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue[sim_node()][/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__head[sim_node()]];
}
...
#line 89
{
  /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue_t t = /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__head();

#line 91
  sim_log_debug(211U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__size[sim_node()]);
  if (!/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__empty()) {
      /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__head[sim_node()]++;
      if (/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__head[sim_node()] == 20) {
#line 94
        /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__head[sim_node()] = 0;
        }
#line 95
      /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__size[sim_node()]--;
      /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__printQueue();
...
# 88 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t  /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__dequeue(void ){
#line 88
  struct sendInfo *__nesc_result;
#line 88

#line 88
  __nesc_result = /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__dequeue();
#line 88
...
#line 88
# 75 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static error_t /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/tinyos-main/tos/interfaces/AMPacket.nc"
inline static void /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC__AMPacket__setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC__AMPacket__setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 50);
  return /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}

# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LinkLayerC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 80
...
#line 80
# 126 "/opt/tinyos-main/tos/interfaces/Packet.nc"
inline static void * /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Packet__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 118
{
  if (!/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[sim_node()]) {



      pack *msg = (pack *)/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Packet__getPayload(&/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[sim_node()], sizeof(pack ));


      *msg = *message;


      if (/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__AMSend__send(dest, &/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[sim_node()], sizeof(pack )) == SUCCESS) {

          /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[sim_node()] = TRUE;
          return SUCCESS;
        }
      else 
#line 133
...
# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t  /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__head(void ){
#line 80
  struct sendInfo *__nesc_result;
#line 80

#line 80
  __nesc_result = /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__Queue__head();
#line 80
...
#line 74
{
  ...
  if (!/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__empty() && !/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[sim_node()]) {
      sendInfo *info;




      info = /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__head();


      if (SUCCESS == /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__send(info->src, info->dest, & info->packet)) {

          /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__dequeue();
          /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__put(info);
        }
    }
  ...
  if (!/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__empty()) {
      /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__postSendTask();
    }
}
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f1c0993a020){
#line 75
  switch (arg_0x7f1c0993a020) {
#line 75
...
#line 75
      break;
#line 75
    case /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask:
#line 75
      /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask__runTask();
#line 75
      break;
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f1c0993a020);
#line 75
      break;
#line 75
    }
...
#line 78
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f1c090e4b60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f1c090e4b60, addr, msg, len);
#line 80
...
# 3 "lib/interfaces/LinkLayer.nc"
inline static void NeighborDiscoveryP__Link__repack(uint16_t src, uint16_t dest, pack payload){
#line 3
  LinkLayerP__LinkLayer__repack(src, dest, payload);
#line 3
}
...
#line 76
{
  sim_log_debug(181U, NEIGHBOR_CHANNEL, "Firing ND\n");
  NeighborDiscoveryP__package(&NeighborDiscoveryP__NDPackage[sim_node()], sequence, -1, PROTOCOL_PING, "Hello?");
  sequence++;
  NeighborDiscoveryP__Link__repack(TOS_NODE_ID, AM_BROADCAST_ADDR, NeighborDiscoveryP__NDPackage[sim_node()]);
  NeighborDiscoveryP__updateNT();
  NeighborDiscoveryP__NeighborDiscovery__printNeighbors();
}
...
#line 23
  for (i = 0; i < 20 + 1; i++) {
      FloodingP__nodeSeq[sim_node()][i].lastSeq = 0;
    }
}
...
{
  FloodingP__initSeq();
  sim_log_debug(188U, FLOODING_CHANNEL, "Flooding to %d: Payload: %s\n", dest, payload);
  FloodingP__package(&FloodingP__FPackage[sim_node()], TOS_NODE_ID, dest, FloodingP__Fsequence[sim_node()], 25, protocol, payload);
  FloodingP__Flooding__sendPack(FloodingP__FPackage[sim_node()], TOS_NODE_ID);
  FloodingP__Fsequence[sim_node()]++;
}

# 2 "lib/interfaces/Flooding.nc"
inline static void LinkStateP__Flood__Flood(uint16_t dest, uint8_t protocol, uint8_t *payload){
#line 2
  FloodingP__Flooding__Flood(dest, protocol, payload);
#line 2
}
#line 2
...
#line 151
  ...
  for (j = 1; j < 19 + 1; j++) {
      for (i = 1; i < 19 + 1; i++) {
          if (LinkStateP__graph[sim_node()][nodeID - 1][i - 1].cost > 0 && LinkStateP__graph[sim_node()][nodeID - 1][i - 1].cost < 255 && i != TOS_NODE_ID && LinkStateP__confirmed[sim_node()][i].cost == 255) {
              LinkStateP__tentative[sim_node()][i].next = i;
              minID = LinkStateP__tentative[sim_node()][i].next;
              if (nodeID == TOS_NODE_ID) {
                  LinkStateP__tentative[sim_node()][i].cost = LinkStateP__graph[sim_node()][nodeID - 1][i - 1].cost;
                  LinkStateP__tentative[sim_node()][i].thru = i;
                }
              else {
#line 163
                if (LinkStateP__graph[sim_node()][nodeID - 1][i - 1].cost + LinkStateP__confirmed[sim_node()][nodeID].cost < LinkStateP__confirmed[sim_node()][i].cost) {
                    LinkStateP__tentative[sim_node()][i].cost = LinkStateP__graph[sim_node()][nodeID - 1][i - 1].cost + LinkStateP__confirmed[sim_node()][nodeID].cost;
                    LinkStateP__tentative[sim_node()][i].thru = LinkStateP__confirmed[sim_node()][nodeID].thru;
                  }
                else 
#line 166
                  {
              ...
              if (LinkStateP__tentative[sim_node()][i].cost < LinkStateP__tentative[sim_node()][minID].cost && LinkStateP__confirmed[sim_node()][i].cost == 255) {
                  minID = i;
                }
            }
        }
      ...
      if (LinkStateP__tentative[sim_node()][minID].cost < LinkStateP__confirmed[sim_node()][minID].cost) {
          LinkStateP__confirmed[sim_node()][minID].next = LinkStateP__tentative[sim_node()][minID].next;
          LinkStateP__confirmed[sim_node()][minID].cost = LinkStateP__tentative[sim_node()][minID].cost;
          LinkStateP__confirmed[sim_node()][minID].thru = LinkStateP__tentative[sim_node()][minID].thru;
          LinkStateP__tentative[sim_node()][minID].cost = 254;
        }
  ...
  updateFlag = 0;
  LinkStateP__printRoutingTable(7);
}

# 5 "lib/interfaces/NeighborDiscovery.nc"
inline static uint8_t LinkStateP__ND__getIsNeighbor(int x){
#line 5
  unsigned char __nesc_result;
#line 5
...
#line 115
  LinkStateP__stab[sim_node()]++;
  if (updateFlag && LinkStateP__stab[sim_node()] > 10) {
      LinkStateP__stab[sim_node()] = 0;
    }
  LSA[0] = TOS_NODE_ID;

  for (i = 1; i < 19 + 1; i++) {
      if (LinkStateP__ND__getIsNeighbor(i)) {
          LinkStateP__graph[sim_node()][TOS_NODE_ID - 1][i - 1].cost = 1;
        }
    }

  for (i = 0; i < 19; i++) {
      LSA[i + 1] = LinkStateP__graph[sim_node()][TOS_NODE_ID - 1][i].cost;
    }

  if (LinkStateP__stab[sim_node()] == 5) {

      LinkStateP__LinkState__SP();
    }
  LinkStateP__Flood__Flood((void *)0, PROTOCOL_LINKSTATE, LSA);
  LinkStateP__Delay__startPeriodic(60000);
}

# 67 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static error_t /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP__TaskBasic__postTask(/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask);
#line 67
...
#line 103
{
  /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask__postTask();
}
...
#line 62
{
  ...
  while (TransportP__oldPackets__size() > 0 && !flag) {
      temp = TransportP__oldPackets__dequeue();
      for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
          if (__nesc_ntoh_uint8(temp.destPort.nxdata) == __nesc_ntoh_uint8(TransportP__sockets[sim_node()][i].dest.port.nxdata) && !flag) {
              fd = i + 1;
              flag = TRUE;

              TransportP__Retransmit__startPeriodic(2 * TransportP__sockets[sim_node()][fd - 1].RTT);
            }
        }

      if (__nesc_ntoh_uint16(temp.seq.nxdata) <= TransportP__sockets[sim_node()][fd - 1].lastAck) {
        }
      else {
        if (TransportP__sockets[sim_node()][fd - 1].state == ESTABLISHED) {

            if (__nesc_ntoh_uint8(temp.flags.nxdata) > 3) {
                sim_log_debug(217U, PROJECT3TGEN, "Retransmitting packet: %d, %d\n", __nesc_ntoh_uint8(temp.flags.nxdata), TransportP__sockets[sim_node()][fd - 1].lastAck);
                TransportP__IP__build(__nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata), __nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].dest.addr.nxdata), PROTOCOL_TCP, &temp);
                TransportP__oldPackets__enqueue(temp);
              }
          }
        else {
#line 89
          if (TransportP__sockets[sim_node()][fd - 1].state == SYN_SENT) {
              sim_log_debug(218U, PROJECT3TGEN, "Reattempting connection\n");
              TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), 
              TransportP__sockets[sim_node()][fd - 1].seq, 0, 1, 5, 0, "");
              sim_log_debug(219U, PROJECT3TGEN, "ATTEMPTING CONNECTION\n");
...
#line 99
            if (TransportP__sockets[sim_node()][fd - 1].state == CLOSING) {
...
#line 108
  if (TransportP__oldPackets__size() == 0 && TransportP__sockets[sim_node()][fd - 1].state == ESTABLISHED) {

      TransportP__Retransmit__startPeriodic(10000);
    }
}
...
#line 118
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      if (TransportP__sockets[sim_node()][i].state == CLOSING) {

          fd = i + 1;
          TransportP__Transport__release(fd);
        }
    }
}
...
#line 130
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      if (TransportP__sockets[sim_node()][i].sendBuff[0] == (void *)0 && TransportP__sockets[sim_node()][i].state == CLOSING) {
...
#line 143
  sim_log_debug(220U, TRANSPORT_CHANNEL, "IN SENDDATA\n");
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      if (TransportP__sockets[sim_node()][i].effectiveWindow > 64) {
          window = 3;
        }
      else {
#line 147
        if (TransportP__sockets[sim_node()][i].effectiveWindow > 32 && TransportP__sockets[sim_node()][i].effectiveWindow <= 64) {
            window = 2;
          }
        else {
#line 149
          if (TransportP__sockets[sim_node()][i].effectiveWindow > 16 && TransportP__sockets[sim_node()][i].effectiveWindow <= 32) {
              window = 1;
            }
          else 
#line 151
...
#line 155
      while (TransportP__sockets[sim_node()][i].sendBuff[0] != (void *)0 && TransportP__sockets[sim_node()][i].outstanding < window) {
          fd = i + 1;



          memcpy(buff, TransportP__sockets[sim_node()][fd - 1].sendBuff, 8);
          sim_log_debug(221U, PROJECT3TGEN, "truncated payload: %.8s unacked: %d\n", buff, TransportP__sockets[sim_node()][fd - 1].outstanding);
          if (TransportP__sockets[sim_node()][fd - 1].bufflen > 7) {
              TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), TransportP__sockets[sim_node()][fd - 1].lastSent + 1, TransportP__sockets[sim_node()][fd - 1].lastRcvd, 4, TransportP__sockets[sim_node()][fd - 1].effectiveWindow, 8, buff);
              TransportP__sockets[sim_node()][fd - 1].lastSent += 1;
            }
          else 
#line 165
            {
              TransportP__tcpPackage(&TransportP__tPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), TransportP__sockets[sim_node()][fd - 1].lastSent + 1, TransportP__sockets[sim_node()][fd - 1].lastRcvd, 4, TransportP__sockets[sim_node()][fd - 1].effectiveWindow, TransportP__sockets[sim_node()][fd - 1].bufflen, buff);
              TransportP__sockets[sim_node()][fd - 1].lastSent += 1;
            }
          TransportP__sockets[sim_node()][fd - 1].outstanding += 1;
          TransportP__IP__build(__nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata), __nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].dest.addr.nxdata), PROTOCOL_TCP, &TransportP__tPackage[sim_node()]);
          ...
          for (j = 0; j < SOCKET_BUFFER_SIZE; j++) {
              if (j + 8 < SOCKET_BUFFER_SIZE) {
                  TransportP__sockets[sim_node()][fd - 1].sendBuff[j] = TransportP__sockets[sim_node()][fd - 1].sendBuff[j + 8];
                }
              else 
#line 175
                {
                  TransportP__sockets[sim_node()][fd - 1].sendBuff[j] = (void *)0;
                }
            }
          TransportP__sockets[sim_node()][fd - 1].bufflen -= 8;
        }
    }
  TransportP__Retransmit__startPeriodic(2 * TransportP__sockets[sim_node()][fd - 1].RTT);
}
...
#line 53
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      if (TransportP__sockets[sim_node()][i].state == LISTEN) {
...
#line 28
  ...
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      if (TransportP__sockets[sim_node()][i].lastWritten < TransportP__sockets[sim_node()][i].transfer && flag == -1 && TransportP__sockets[sim_node()][i].sendBuff[0] == (void *)0) {
          fd = i + 1;
          flag = 0;
        }
    }
  ...
  if (flag == 0) {
      ...
      TransportP__sockets[sim_node()][fd - 1].lastWritten = temp;
      sim_log_debug(216U, TRANSPORT_CHANNEL, "TRANSFER STRING: %.*s\n", i, buffer);
      TransportP__Transport__write(fd, buffer, i);
    }
}
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f1c09196950){
#line 83
  switch (arg_0x7f1c09196950) {
#line 83
    case 0U:
#line 83
...
#line 83
    case 2U:
#line 83
      LinkStateP__Delay__fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      TransportP__Retransmit__fired();
#line 83
      break;
#line 83
    case 5U:
#line 83
      TransportP__Close__fired();
#line 83
      break;
#line 83
    case 6U:
#line 83
      TransportP__LongClose__fired();
#line 83
      break;
#line 83
    case 7U:
#line 83
      TransportP__SendData__fired();
#line 83
      break;
#line 83
    case 8U:
#line 83
      TransportP__listenClose__fired();
#line 83
      break;
#line 83
    case 9U:
#line 83
      TransportP__writeTimer__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f1c09196950);
#line 83
      break;
#line 83
    }
...
#line 67
  for (i = 0; i < 20; i++) {
      /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[sim_node()][i] = &/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool[sim_node()][i];
    }
  /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()] = 20;
  /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()] = 0;
  return SUCCESS;
}
...
#line 62
  __nesc_result = /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__Init__init();
#line 62
...
#line 85
{
  if (__nesc_ntoh_uint8(request->protocol.nxdata) == PROTOCOL_PING) {

      NeighborDiscoveryP__NeighborTable[sim_node()][__nesc_ntoh_uint16(request->src.nxdata)].requests++;
      NeighborDiscoveryP__package(&NeighborDiscoveryP__NDReturn[sim_node()], __nesc_ntoh_uint16(request->seq.nxdata), __nesc_ntoh_uint8(request->TTL.nxdata), PROTOCOL_PINGREPLY, "Hello Neighbor!");
      NeighborDiscoveryP__Link__repack(TOS_NODE_ID, source, NeighborDiscoveryP__NDReturn[sim_node()]);
    }
  else {
#line 91
    if (__nesc_ntoh_uint8(request->protocol.nxdata) == PROTOCOL_PINGREPLY) {

        sim_log_debug(182U, NEIGHBOR_CHANNEL, "Collecting Neighbor Stats\n");

        NeighborDiscoveryP__NeighborTable[sim_node()][__nesc_ntoh_uint16(request->src.nxdata)].responses++;
        NeighborDiscoveryP__NeighborDiscovery__newStats(request);
      }
    else {
        sim_log_debug(183U, NEIGHBOR_CHANNEL, "Packet sent to WRONG interface!\n");
      }
    }
}
...
#line 49
{
  ...
  if (!/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__empty()) {
      sendInfo *input;

      input = /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__get();
      input->packet = msg;
      input->dest = dest;



      /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__enqueue(input);
...
#line 76
  ...
  for (i = /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__head[sim_node()]; i < /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__head[sim_node()] + /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__size[sim_node()]; i++) {
      sim_log_debug_clear(207U, "QueueC", "[");
      for (j = 0; j < sizeof(/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue_t ); j++) {
          uint8_t v = ((uint8_t *)&/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue[sim_node()][i % 20])[j];
...
#line 38
{
  ...
  if (/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__isRunning() == FALSE) {

      /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__startOneShot(/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Random__rand16() % 300);
    }
}
...
#line 83
  ...
  LinkStateP__initGraph();
  updateFlag = 1;
  temp = LinkStateP__Random__rand16();
  temp = temp / 250;



  LinkStateP__Delay__startOneShot(5000 + temp);
}
...
#line 45
  for (i = 0; i < 19 + 1; i++) {
      LinkStateP__tentative[sim_node()][i].next = TOS_NODE_ID;
      LinkStateP__tentative[sim_node()][i].cost = -1;
      LinkStateP__tentative[sim_node()][i].thru = TOS_NODE_ID;
      if (i != TOS_NODE_ID) {
          LinkStateP__confirmed[sim_node()][i].next = TOS_NODE_ID;
          LinkStateP__confirmed[sim_node()][i].cost = -1;
          LinkStateP__confirmed[sim_node()][i].thru = (void *)0;
        }
      else 
#line 53
        {
          LinkStateP__confirmed[sim_node()][i].next = TOS_NODE_ID;
          LinkStateP__confirmed[sim_node()][i].cost = 0;
          LinkStateP__confirmed[sim_node()][i].thru = TOS_NODE_ID;
        }
    }
}
  ...
  for (i = 0; i < 19; i++) {
      for (j = 0; j < 19; j++) {
          if (i == j && TOS_NODE_ID - 1 == i) {
              LinkStateP__graph[sim_node()][i][j].cost = 0;
            }
          else 
#line 36
            {
              LinkStateP__graph[sim_node()][i][j].cost = 255;
            }
        }
    }
}
...
#line 46
  for (i = 0; i < 20; i++) {
      if (NeighborDiscoveryP__NeighborTable[sim_node()][i].isNeighbor == 1) {
          NeighborDiscoveryP__NeighborTable[sim_node()][i].TTL--;
          if (NeighborDiscoveryP__NeighborTable[sim_node()][i].TTL <= 0 || NeighborDiscoveryP__NeighborTable[sim_node()][i].responses * 3 <= NeighborDiscoveryP__NeighborTable[sim_node()][TOS_NODE_ID].requests) {
              NeighborDiscoveryP__NeighborTable[sim_node()][i].isNeighbor = 0;
              if (flag) {
                  NeighborDiscoveryP__LinkState__update();
                }
...
# 38 "lib/modules/FloodingP.nc"
static void FloodingP__Flooding__control(pack *Fpacket)
#line 38
{

  FloodingP__package(&FloodingP__FPackage[sim_node()], __nesc_ntoh_uint16(Fpacket->src.nxdata), __nesc_ntoh_uint16(Fpacket->dest.nxdata), __nesc_ntoh_uint16(Fpacket->seq.nxdata), __nesc_ntoh_uint8(Fpacket->TTL.nxdata) - 1, __nesc_ntoh_uint8(Fpacket->protocol.nxdata), Fpacket->payload);
  sim_log_debug(189U, FLOODING_CHANNEL, "Flood Packet Received\n");
  if (__nesc_ntoh_uint8(FloodingP__FPackage[sim_node()].protocol.nxdata) == PROTOCOL_LINKSTATE) {

      FloodingP__LinkState__fill(__nesc_ntoh_uint16(Fpacket->src.nxdata), FloodingP__FPackage[sim_node()].payload);
    }
  if (TOS_NODE_ID == __nesc_ntoh_uint16(FloodingP__FPackage[sim_node()].dest.nxdata)) {
      if (__nesc_ntoh_uint16(FloodingP__FPackage[sim_node()].seq.nxdata) > FloodingP__nodeSeq[sim_node()][__nesc_ntoh_uint16(FloodingP__FPackage[sim_node()].dest.nxdata)].lastSeq) {
          sim_log_debug(190U, FLOODING_CHANNEL, "!!!!!!!! Destination Reached: Payload: %s\n", Fpacket->payload);
          FloodingP__nodeSeq[sim_node()][__nesc_ntoh_uint16(FloodingP__FPackage[sim_node()].dest.nxdata)].lastSeq = __nesc_ntoh_uint16(FloodingP__FPackage[sim_node()].seq.nxdata);
        }
    }
  else {
#line 52
    if (__nesc_ntoh_uint8(FloodingP__FPackage[sim_node()].TTL.nxdata) > 0) {

        FloodingP__Flooding__sendPack(FloodingP__FPackage[sim_node()], __nesc_ntoh_uint16(Fpacket->src.nxdata));
      }
    else 
#line 55
      {
        sim_log_debug(191U, FLOODING_CHANNEL, "Flood Ended by TTL\n");
      }
    }
}
...
#line 62
  sim_log_debug(192U, FLOODING_CHANNEL, "Finding Valid Neighbors\n");
  if (__nesc_ntoh_uint16(Fpkg.seq.nxdata) >= FloodingP__nodeSeq[sim_node()][Fsrc].lastSeq) {
      for (i = 0; i < 20; i++) {
          if (FloodingP__Neighbors__getIsNeighbor(i) && __nesc_ntoh_uint8(Fpkg.TTL.nxdata) >= 0 && i != Fsrc) {
              sim_log_debug(193U, FLOODING_CHANNEL, "Flooding -> %d\n", i);
              FloodingP__nodeSeq[sim_node()][Fsrc].lastSeq = __nesc_ntoh_uint16(Fpkg.seq.nxdata);
              FloodingP__Link__repack(TOS_NODE_ID, i, Fpkg);
              flag++;
            }
        }

      if (!flag) {
          sim_log_debug(194U, FLOODING_CHANNEL, "No Valid Neighbors\n");
        }
    }
  else 
#line 76
    {
      sim_log_debug(195U, FLOODING_CHANNEL, "Repeated Packet!\n");
    }
}
...
#line 25
{
  IPP__packIt(&IPP__IPPkt[sim_node()], __nesc_ntoh_uint16(payload->src.nxdata), __nesc_ntoh_uint16(payload->dest.nxdata), __nesc_ntoh_uint8(payload->protocol.nxdata), payload->payload);

  if (__nesc_ntoh_uint16(IPP__IPPkt[sim_node()].dest.nxdata) == TOS_NODE_ID) {
      IPP__IP__sortReply(payload);
    }
  else {
#line 30
    if (IPP__LinkState__getNext(__nesc_ntoh_uint16(payload->dest.nxdata)) == 0) {
        sim_log_debug(213U, ROUTING_CHANNEL, "DESTINATION UNREACHABLE!\n");
      }
    else 
#line 32
      {

        IPP__Link__repack(TOS_NODE_ID, IPP__LinkState__getNext(__nesc_ntoh_uint16(payload->dest.nxdata)), IPP__IPPkt[sim_node()]);
      }
    }
}
...
#line 53
{
  __nesc_hton_uint16(IPPacket->src.nxdata, src);
  __nesc_hton_uint16(IPPacket->dest.nxdata, dest);
  __nesc_hton_uint8(IPPacket->protocol.nxdata, protocol);
  memcpy(IPPacket->payload, payload, PACKET_MAX_PAYLOAD_SIZE);
}

# 233 "lib/modules/TransportP.nc"
static socket_t TransportP__Transport__socket(void )
#line 233
{
  uint8_t i;
...
#line 237
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      if (! TransportP__sockets[sim_node()][i].flag && !flag) {
          flag = 1;
          temp = i + 1;
        }
    }
...
{
  __nesc_hton_uint16(Package->src.nxdata, src);
  __nesc_hton_uint8(Package->srcPort.nxdata, srcPort);
  __nesc_hton_uint8(Package->destPort.nxdata, destPort);
  __nesc_hton_uint16(Package->seq.nxdata, seq);
  __nesc_hton_uint8(Package->ack.nxdata, ack);
  __nesc_hton_uint8(Package->flags.nxdata, flags);
  __nesc_hton_uint8(Package->adWindow.nxdata, adWindow);
  __nesc_hton_uint8(Package->data.nxdata, data);
  memcpy(Package->payload, payload, PACKET_MAX_PAYLOAD_SIZE);
}
...
#line 101
{
  if (/*TransportC.oldPackets*/QueueC__1__Queue__size() < /*TransportC.oldPackets*/QueueC__1__Queue__maxSize()) {
      sim_log_debug(254U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*TransportC.oldPackets*/QueueC__1__size[sim_node()]);
      /*TransportC.oldPackets*/QueueC__1__queue[sim_node()][/*TransportC.oldPackets*/QueueC__1__tail[sim_node()]] = newVal;
      /*TransportC.oldPackets*/QueueC__1__tail[sim_node()]++;
      if (/*TransportC.oldPackets*/QueueC__1__tail[sim_node()] == 64) {
#line 106
        /*TransportC.oldPackets*/QueueC__1__tail[sim_node()] = 0;
        }
#line 107
      /*TransportC.oldPackets*/QueueC__1__size[sim_node()]++;
      /*TransportC.oldPackets*/QueueC__1__printQueue();
      return SUCCESS;
    }
  else {
      return FAIL;
...
#line 76
  ...
  for (i = /*TransportC.oldPackets*/QueueC__1__head[sim_node()]; i < /*TransportC.oldPackets*/QueueC__1__head[sim_node()] + /*TransportC.oldPackets*/QueueC__1__size[sim_node()]; i++) {
      sim_log_debug_clear(249U, "QueueC", "[");
      for (j = 0; j < sizeof(/*TransportC.oldPackets*/QueueC__1__queue_t ); j++) {
          uint8_t v = ((uint8_t *)&/*TransportC.oldPackets*/QueueC__1__queue[sim_node()][i % 64])[j];
...
# 21 "lib/modules/ChatP.nc"
static uint8_t *ChatP__concat(uint8_t *str1, uint8_t *str2)
#line 21
{
  int strlength = strlen((const uint8_t *)str1) + strlen((const uint8_t *)str2);
#line 22
  int i;
  uint8_t *temp = (uint8_t *)malloc((strlength + 1) * sizeof(uint8_t ));

#line 24
  sim_log_debug(255U, TRANSPORT_CHANNEL, "Concat: %s, %s, %d\n", str1, str2, strlen((const uint8_t *)str1) + strlen((const uint8_t *)str2));
...
#line 298
  sim_log_debug(227U, TRANSPORT_CHANNEL, "IN WRITE %s, %d\n", buff, bufflen);
  if (bufflen <= 128) {
      for (i = 0; i < 128; i++) {
          if (TransportP__sockets[sim_node()][fd - 1].sendBuff[i] == (void *)0 && j < bufflen) {
              TransportP__sockets[sim_node()][fd - 1].sendBuff[i] = buff[j];
              j++;
            }
        }
    }
      ...
      TransportP__Transport__write(fd, buff, bufflen - j);
    }


  sim_log_debug(228U, TRANSPORT_CHANNEL, "buff: %s\n", TransportP__sockets[sim_node()][fd - 1].sendBuff);
  TransportP__sockets[sim_node()][fd - 1].bufflen = bufflen;
  TransportP__SendData__startPeriodic(1000);
}
...
#line 73
# 89 "/opt/tinyos-main/tos/system/QueueC.nc"
static /*TransportC.oldPackets*/QueueC__1__queue_t /*TransportC.oldPackets*/QueueC__1__Queue__dequeue(void )
#line 89
{
  /*TransportC.oldPackets*/QueueC__1__queue_t t = /*TransportC.oldPackets*/QueueC__1__Queue__head();

#line 91
  sim_log_debug(253U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*TransportC.oldPackets*/QueueC__1__size[sim_node()]);
  if (!/*TransportC.oldPackets*/QueueC__1__Queue__empty()) {
      /*TransportC.oldPackets*/QueueC__1__head[sim_node()]++;
      if (/*TransportC.oldPackets*/QueueC__1__head[sim_node()] == 64) {
#line 94
        /*TransportC.oldPackets*/QueueC__1__head[sim_node()] = 0;
        }
#line 95
      /*TransportC.oldPackets*/QueueC__1__size[sim_node()]--;
      /*TransportC.oldPackets*/QueueC__1__printQueue();
...
#line 62
  for (i = 0; i < 20; i++) {
      if (NeighborDiscoveryP__NeighborTable[sim_node()][i].isNeighbor == 1) {
          sim_log_debug(179U, NEIGHBOR_CHANNEL, "%d -> %d\n", TOS_NODE_ID, i);
        }
    }
}

# 61 "lib/modules/LinkStateP.nc"
static void LinkStateP__printRoutingTable(uint8_t node)
#line 61
{
  int i;
...
#line 63
  if (TOS_NODE_ID == node) {
      sim_log_debug(196U, ROUTING_CHANNEL, "%d's Routing Table:\n", node);
      for (i = 1; i < 19 + 1; i++) {

          sim_log_debug(197U, ROUTING_CHANNEL, "ROUTE TO %d: Through %d Cost: %d\n", LinkStateP__confirmed[sim_node()][i].next, LinkStateP__confirmed[sim_node()][i].thru, LinkStateP__confirmed[sim_node()][i].cost);
        }
    }
}

# 246 "lib/modules/TransportP.nc"
static error_t TransportP__Transport__bind(socket_t fd, socket_addr_t *addr)
#line 246
{
  int flag = FAIL;
...
#line 248
  if (fd == 0 || TransportP__availPort[sim_node()][__nesc_ntoh_uint8(addr->port.nxdata)]) {
    }
  else {
      TransportP__sockets[sim_node()][fd - 1].flag = 1;
      ...
      TransportP__sockets[sim_node()][fd - 1].outstanding = 0;
      TransportP__sockets[sim_node()][fd - 1].lastWritten = 0;
      TransportP__sockets[sim_node()][fd - 1].effectiveWindow = SOCKET_BUFFER_SIZE;
      TransportP__availPort[sim_node()][__nesc_ntoh_uint8(addr->port.nxdata)] = TRUE;
      flag = SUCCESS;
    }
  sim_log_debug(225U, TRANSPORT_CHANNEL, "BINDING: %d, %d ON SOCKET: %d\n", __nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata), __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata), fd);
  return flag;
}
...
#line 617
  if (TransportP__sockets[sim_node()][fd - 1].state == CLOSING) {
      TransportP__availPort[sim_node()][__nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata)] = FALSE;
      TransportP__sockets[sim_node()][fd - 1].flag = 0;
      ...
      TransportP__sockets[sim_node()][fd - 1].lastWritten = 0;
      TransportP__sockets[sim_node()][fd - 1].lastAck = 0;
      TransportP__sockets[sim_node()][fd - 1].lastSent = 0;
      ...
      while (TransportP__oldPackets__size() > 0) {
          temp = TransportP__oldPackets__dequeue();
          sim_log_debug(245U, PROJECT3TGEN, "Packet Queued: %d, %.8s\n", __nesc_ntoh_uint16(temp.seq.nxdata), temp.payload);
        }
      TransportP__sockets[sim_node()][fd - 1].bufflen = 0;
      TransportP__sockets[sim_node()][fd - 1].RTT = 0;
      TransportP__sockets[sim_node()][fd - 1].effectiveWindow = 0;
      sim_log_debug(246U, TRANSPORT_CHANNEL, "Socket %d Closed!\n", fd);
      flag = SUCCESS;
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "NeighborDiscoveryP__NDPackage"))
  {
    *addr = (uintptr_t)&NeighborDiscoveryP__NDPackage[__nesc_mote];
    *size = sizeof(NeighborDiscoveryP__NDPackage[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NeighborDiscoveryP__NDReturn"))
  {
    *addr = (uintptr_t)&NeighborDiscoveryP__NDReturn[__nesc_mote];
    *size = sizeof(NeighborDiscoveryP__NDReturn[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NeighborDiscoveryP__NeighborTable"))
  {
    *addr = (uintptr_t)&NeighborDiscoveryP__NeighborTable[__nesc_mote];
    *size = sizeof(NeighborDiscoveryP__NeighborTable[__nesc_mote]);
    return 0;
  }
  ...
  /* Module FloodingP */
  if (!strcmp(varname, "FloodingP__Fsequence"))
  {
    *addr = (uintptr_t)&FloodingP__Fsequence[__nesc_mote];
    *size = sizeof(FloodingP__Fsequence[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingP__FPackage"))
  {
    *addr = (uintptr_t)&FloodingP__FPackage[__nesc_mote];
    *size = sizeof(FloodingP__FPackage[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingP__nodeSeq"))
  {
    *addr = (uintptr_t)&FloodingP__nodeSeq[__nesc_mote];
    *size = sizeof(FloodingP__nodeSeq[__nesc_mote]);
    return 0;
  }

  /* Module LinkStateP */
  if (!strcmp(varname, "LinkStateP__stab"))
  {
    *addr = (uintptr_t)&LinkStateP__stab[__nesc_mote];
    *size = sizeof(LinkStateP__stab[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LinkStateP__graph"))
  {
    *addr = (uintptr_t)&LinkStateP__graph[__nesc_mote];
    *size = sizeof(LinkStateP__graph[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LinkStateP__confirmed"))
  {
    *addr = (uintptr_t)&LinkStateP__confirmed[__nesc_mote];
    *size = sizeof(LinkStateP__confirmed[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LinkStateP__tentative"))
  {
    *addr = (uintptr_t)&LinkStateP__tentative[__nesc_mote];
    *size = sizeof(LinkStateP__tentative[__nesc_mote]);
    return 0;
  }

  /* Module SimpleSendP__1 */
  if (!strcmp(varname, "/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy"))
  {
    *addr = (uintptr_t)&/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[__nesc_mote];
    *size = sizeof(/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt"))
  {
    *addr = (uintptr_t)&/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[__nesc_mote];
    *size = sizeof(/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[__nesc_mote]);
    return 0;
  }
  ...
  /* Module PoolP__2 */
  if (!strcmp(varname, "/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free"))
  {
    *addr = (uintptr_t)&/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[__nesc_mote];
    *size = sizeof(/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index"))
  {
    *addr = (uintptr_t)&/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[__nesc_mote];
    *size = sizeof(/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue"))
  {
    *addr = (uintptr_t)&/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[__nesc_mote];
    *size = sizeof(/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool"))
  {
    *addr = (uintptr_t)&/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool[__nesc_mote];
    *size = sizeof(/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool[__nesc_mote]);
    return 0;
  }

  /* Module QueueC__3 */
  if (!strcmp(varname, "/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue"))
  {
    *addr = (uintptr_t)&/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue[__nesc_mote];
    *size = sizeof(/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__head"))
  {
    *addr = (uintptr_t)&/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__head[__nesc_mote];
    *size = sizeof(/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__head[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__tail"))
  {
    *addr = (uintptr_t)&/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__tail[__nesc_mote];
    *size = sizeof(/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__tail[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__size"))
  {
    *addr = (uintptr_t)&/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__size[__nesc_mote];
    *size = sizeof(/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__size[__nesc_mote]);
    return 0;
  }

  /* Module IPP */
  if (!strcmp(varname, "IPP__IPPkt"))
  {
    *addr = (uintptr_t)&IPP__IPPkt[__nesc_mote];
    *size = sizeof(IPP__IPPkt[__nesc_mote]);
    return 0;
  }
  ...
  /* Module TransportP */
  if (!strcmp(varname, "TransportP__availPort"))
  {
    *addr = (uintptr_t)&TransportP__availPort[__nesc_mote];
    *size = sizeof(TransportP__availPort[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "TransportP__tPackage"))
  {
    *addr = (uintptr_t)&TransportP__tPackage[__nesc_mote];
    *size = sizeof(TransportP__tPackage[__nesc_mote]);
    return 0;
  }

  /* Module QueueC__1 */
  if (!strcmp(varname, "/*TransportC.oldPackets*/QueueC__1__queue"))
  {
    *addr = (uintptr_t)&/*TransportC.oldPackets*/QueueC__1__queue[__nesc_mote];
    *size = sizeof(/*TransportC.oldPackets*/QueueC__1__queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*TransportC.oldPackets*/QueueC__1__head"))
  {
    *addr = (uintptr_t)&/*TransportC.oldPackets*/QueueC__1__head[__nesc_mote];
    *size = sizeof(/*TransportC.oldPackets*/QueueC__1__head[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*TransportC.oldPackets*/QueueC__1__tail"))
  {
    *addr = (uintptr_t)&/*TransportC.oldPackets*/QueueC__1__tail[__nesc_mote];
    *size = sizeof(/*TransportC.oldPackets*/QueueC__1__tail[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*TransportC.oldPackets*/QueueC__1__size"))
  {
    *addr = (uintptr_t)&/*TransportC.oldPackets*/QueueC__1__size[__nesc_mote];
    *size = sizeof(/*TransportC.oldPackets*/QueueC__1__size[__nesc_mote]);
    return 0;
  }

  /* Module ChatP */
  if (!strcmp(varname, "ChatP__usrs"))
  {
    *addr = (uintptr_t)&ChatP__usrs[__nesc_mote];
    *size = sizeof(ChatP__usrs[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module NeighborDiscoveryP */
  memset((void *)&NeighborDiscoveryP__NDPackage[__nesc_mote], 0, sizeof NeighborDiscoveryP__NDPackage[__nesc_mote]);
  memset((void *)&NeighborDiscoveryP__NDReturn[__nesc_mote], 0, sizeof NeighborDiscoveryP__NDReturn[__nesc_mote]);
  memset((void *)&NeighborDiscoveryP__NeighborTable[__nesc_mote], 0, sizeof NeighborDiscoveryP__NeighborTable[__nesc_mote]);

  /* Module LinkLayerP */

  /* Module FloodingP */
  FloodingP__Fsequence[__nesc_mote] = 1;
  memset((void *)&FloodingP__FPackage[__nesc_mote], 0, sizeof FloodingP__FPackage[__nesc_mote]);
  memset((void *)&FloodingP__nodeSeq[__nesc_mote], 0, sizeof FloodingP__nodeSeq[__nesc_mote]);

  /* Module LinkStateP */
  memset((void *)&LinkStateP__stab[__nesc_mote], 0, sizeof LinkStateP__stab[__nesc_mote]);
  memset((void *)&LinkStateP__graph[__nesc_mote], 0, sizeof LinkStateP__graph[__nesc_mote]);
  memset((void *)&LinkStateP__confirmed[__nesc_mote], 0, sizeof LinkStateP__confirmed[__nesc_mote]);
  memset((void *)&LinkStateP__tentative[__nesc_mote], 0, sizeof LinkStateP__tentative[__nesc_mote]);

  /* Module SimpleSendP__1 */
  /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[__nesc_mote] = FALSE;
  memset((void *)&/*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[__nesc_mote], 0, sizeof /*LinkLayerC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[__nesc_mote]);

  /* Module AMQueueEntryP__1 */

  /* Module PoolP__2 */
  memset((void *)&/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[__nesc_mote], 0, sizeof /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[__nesc_mote]);
  memset((void *)&/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[__nesc_mote], 0, sizeof /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[__nesc_mote]);
  memset((void *)&/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[__nesc_mote], 0, sizeof /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[__nesc_mote]);
  memset((void *)&/*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool[__nesc_mote], 0, sizeof /*LinkLayerC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool[__nesc_mote]);

  /* Module QueueC__3 */
  memset((void *)&/*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue[__nesc_mote], 0, sizeof /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__queue[__nesc_mote]);
  /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__head[__nesc_mote] = 0;
  /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__tail[__nesc_mote] = 0;
  /*LinkLayerC.SimpleSendC.QueueC*/QueueC__3__size[__nesc_mote] = 0;

  /* Module IPP */
  memset((void *)&IPP__IPPkt[__nesc_mote], 0, sizeof IPP__IPPkt[__nesc_mote]);

  /* Module MyPingP */

  /* Module TransportP */
  memset((void *)&TransportP__availPort[__nesc_mote], 0, sizeof TransportP__availPort[__nesc_mote]);
  memset((void *)&TransportP__sockets[__nesc_mote], 0, sizeof TransportP__sockets[__nesc_mote]);
  memset((void *)&TransportP__tPackage[__nesc_mote], 0, sizeof TransportP__tPackage[__nesc_mote]);

  /* Module QueueC__1 */
  memset((void *)&/*TransportC.oldPackets*/QueueC__1__queue[__nesc_mote], 0, sizeof /*TransportC.oldPackets*/QueueC__1__queue[__nesc_mote]);
  /*TransportC.oldPackets*/QueueC__1__head[__nesc_mote] = 0;
  /*TransportC.oldPackets*/QueueC__1__tail[__nesc_mote] = 0;
  /*TransportC.oldPackets*/QueueC__1__size[__nesc_mote] = 0;

  /* Module ChatP */
  memset((void *)&ChatP__usrs[__nesc_mote], 0, sizeof ChatP__usrs[__nesc_mote]);
